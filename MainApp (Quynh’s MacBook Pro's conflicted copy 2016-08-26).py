...
class MainApp:
   ...
   def callback_partitioning(self):
      ...
      for i in range(0,len(shared_routes)):
         edges_subnets[i] = {}
         edges_subnets[i][0] = shared_routes[i]
         edges_subnets[i][1] = shared_routes[i]
         ...
         if m<n:
            ...
            for j in range(m,n+1):
               edges_subnets[i][0].append(self.set_border_nodes[j])
            gen = (k for k in self.set_border_nodes if k not in edges_subnets[i][0])
            for k in gen:
               edges_subnets[i][1].append(k)
         else:
            #print 'check n<m'
      ...
      # for i in range(0, len(shared_routes)):
      #    for j in shared_routes[i]:
      #       if j not in edges_subnets[i][0]:
