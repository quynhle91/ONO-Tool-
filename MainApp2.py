...
class MainApp:
    ...
    def __init__(self, parent):
        ...
        self.f2 = Button(self.functionbar, text="partitioning graph", width=10, command=self.callback_partitioning,
                         relief=GROOVE)
        self.f2.pack(side=LEFT, padx=2, pady=2)
    ...
    def callback_partitioning(self):
        ...
        #     while (m+j)%l!= n:
        #         print (m+j)%l
        #         add_nodes[m] += [self.set_border_nodes[(m+j)%l]]
        #         #add_nodes.append(self.set_border_nodes[(m+j)%l])
        #         j += 1
        #     print add_nodes[m]
        #     while (n+k)%l != m:
        #         add_nodes.append(self.set_border_nodes[(n+k)%l])
        #         k += 1
        #     print add_nodes[n]
